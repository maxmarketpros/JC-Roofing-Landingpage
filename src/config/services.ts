...
export const services: ServiceConfig[] = [
  {
    ...
    overviewHeading: "Full-Service Delivery in Springfield, IL",
    benefitsHeading: "What Sets Our Service One Apart",
    benefitsSubtitle:
      "Built for Springfield property owners who want quality craftsmanship without the usual surprises.",
    featureHighlights: [
      {
        title: "Precision at Every Step",
        description:
          "From first measurement to final walkthrough, every Service One project reflects 15+ years of hands-on Springfield experience. Nothing is assumed — every detail is checked, documented, and verified before the next phase begins.",
        imageKey: "service-1-detail-1",
      },
      {
        title: "Built to Last Through Central Illinois Weather",
        description:
          "Local climate takes a toll on lesser work. We spec premium materials and proven installation techniques so our Service One work holds up through every Springfield winter, spring storm, and summer heatwave.",
        imageKey: "service-1-detail-2",
      },
    ],
    scopeHeading: "What's Included in Every Service One Project",
    benefits: [
      {
  ...
  },
  {
    ...
    overviewHeading: "Specialized Service Two for Springfield Properties",
    benefitsHeading: "The Service Two Advantage",
    benefitsSubtitle:
      "Advanced techniques, custom scopes, and dedicated specialists — for projects where the standard approach won't cut it.",
    featureHighlights: [
      {
        title: "Custom Scope, Built Around You",
        description:
          "Every Service Two engagement starts with a deep-dive consultation at your property. We tailor the scope, timeline, and materials to fit your exact goals — never a cookie-cutter proposal and never a scope that was designed for someone else.",
        imageKey: "service-2-detail-1",
      },
      {
        title: "Expert-Led Execution With Multi-Point QC",
        description:
          "A dedicated specialist team handles every phase of your Service Two project, backed by multi-point quality inspections at each milestone. You get the same level of rigor Springfield's biggest commercial properties expect.",
        imageKey: "service-2-detail-2",
      },
    ],
    scopeHeading: "Inside a Service Two Engagement",
    benefits: [
      {
    ...
    topicSectionB: {
      ...
      heading: "Your Local Service Two Partner in Springfield, IL",
      subtitle:
  ...
  },
  {
    ...
    overviewHeading: "End-to-End Service Three Management in Springfield, IL",
    benefitsHeading: "How Service Three Delivers for Springfield Owners",
    benefitsSubtitle:
      "Full accountability, real-time budget tracking, and zero surprises — from kickoff through close-out.",
    featureHighlights: [
      {
        title: "One Point of Accountability, Every Day",
        description:
          "A single dedicated project manager owns every vendor, decision, and milestone. No more chasing subs, no more reconciling conflicting reports — you have one person responsible for the entire Service Three engagement.",
        imageKey: "service-3-detail-1",
      },
      {
        title: "Budget Clarity at Every Milestone",
        description:
          "Real-time line-item budget tracking with transparent monthly reporting. Know exactly where every dollar is going, what's next, and what's at risk — before you're ever asked to approve it.",
        imageKey: "service-3-detail-2",
      },
    ],
    scopeHeading: "The Service Three Playbook",
    benefits: [
      {
    ...
    topicSectionB: {
      ...
      heading: "Service Three Specialists Across Springfield, IL",
      subtitle:
